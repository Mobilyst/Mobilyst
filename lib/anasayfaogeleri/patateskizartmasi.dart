...
class PatatesKizartmasiTumuPage extends ConsumerWidget {
  const PatatesKizartmasiTumuPage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final List<products> filteredMeals = meals
        ...
        .where((urun) => urun.category.toLowerCase() == "patates kızartması")
        .toList();
